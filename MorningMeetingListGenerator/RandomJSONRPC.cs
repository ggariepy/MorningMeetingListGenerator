...
namespace org.random.JSONRPC
{
    public class RandomJSONRPC
    {
        ...
        public string URL = "https://api.random.org/json-rpc/1/invoke";
        ...
        /// </summary>
        /// <param name="apiKey">The api Key from random.org</param>
        /// <param name="URI">The URI to the public API at random.org</param>
        public RandomJSONRPC(String apiKey, string URI)
        {
            mApiKey = apiKey;
            URL = URI;
        }
        ...
        private void SendRequest()
        {
            ...
            if (mJSONResponse.GetValue("result").SelectToken("advisoryDelay", false) != null)
            {
                ...
                // Doesnt like direct conversion to int64
                mAdvisoryDelay = Convert.ToInt64(Convert.ToString(mJSONResponse.GetValue("result").SelectToken("advisoryDelay")));
            }
        }
